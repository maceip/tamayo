// end-to-end verification of docs/tamagotchi.html against the intended design:
...
(async () => {
  ...
  await page.goto("file://" + require("path").resolve(__dirname, "../../docs/tamagotchi.html"), { waitUntil: "networkidle0" });
  await sleep(700);
